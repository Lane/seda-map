...
const DataOptionsDialog2 = ({
  ...
  return (
    <div className={classes['data-options-dialog-2']}>
      <button onClick={handleClickOpen}>More Filters</button>
